...
table(ir_data$marital,ir_data$v501, ) # check grouping
...
-   Variables specific for pregnancy (wanted)

-   Variables specific for married (partner's characteristics, age at first married)

-   Variables related to married (age at first sex)
...
finaldata <- teendata %>% select (c(
  vxxx, # outcome
  vxxx, # exposure
  vxxx, # socio demographic
  vxxx, # socio economnic
  vxxx, # health behaviour
  vxxx, # problem access to services
  vxxx # hh characteristics
))
