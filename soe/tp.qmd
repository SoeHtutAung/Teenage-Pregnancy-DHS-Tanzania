...
### education
svytable(~edu_gp + v025, design = dhs)
...
### 11.1 Forest plot (can use summ of jtools package)

```{r forest_model5}
# preapare a dataframe from model
